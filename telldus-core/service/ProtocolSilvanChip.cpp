...
std::string ProtocolSilvanChip::getStringForMethod(int method, unsigned char data, Controller *controller) {
	if (TelldusCore::comparei(model(), L"kp100")) {
		std::string preamble;
		preamble.append(1, static_cast<char>(100));
		preamble.append(1, static_cast<char>(255));
		preamble.append(1, static_cast<char>(1));
		preamble.append(1, static_cast<char>(255));
		preamble.append(1, static_cast<char>(1));
		preamble.append(1, static_cast<char>(255));
		preamble.append(1, static_cast<char>(1));
		...
		std::string preamble;
		preamble.append(1, static_cast<char>(0x25));
		preamble.append(1, static_cast<char>(255));
		preamble.append(1, static_cast<char>(1));
		preamble.append(1, static_cast<char>(255));
		preamble.append(1, static_cast<char>(1));
